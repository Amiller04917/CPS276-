...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'amiller49';//this will be your WCC username
      $dbUsr = 'amiller49';//this will be your WCC username
      $dbPass = 'ak8Wdfj28q7J';//this will be the password found in the video.
